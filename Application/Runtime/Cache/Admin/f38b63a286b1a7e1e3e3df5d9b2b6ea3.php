            ...
            <div class="content-box-content">
                <div class="tab-content default-tab" id="tab1">
                    ...
                    <table>
                        ...
                        <?php if(is_array($c_an1)): $i = 0; $__LIST__ = $c_an1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c_an1): $mod = ($i % 2 );++$i;?><tr><td><a href="<?php echo U('Admin/stu/c_an1detail',array('id'=>$c_an1['id']));?>"><?php echo ($c_an1['date']); ?></a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
