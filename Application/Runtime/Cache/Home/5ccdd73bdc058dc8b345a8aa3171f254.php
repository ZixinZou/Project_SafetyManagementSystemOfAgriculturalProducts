...
<div id="body-wrapper">
            ...
            <ul id="main-nav">
                ...
                <li> <a href="#" class="nav-top-item  current">
                    ...
                    <ul>
                        ...
                        <li><a href="http://localhost/cms2/index.php/home/user/showAdd">添加学生</a></li>
                ...
                <li> <a href="#" class="nav-top-item ">
                    ...
                    <ul>
                        ...
                        <li><a href="http://localhost/cms2/index.php/home/user/showPwdUpdate">修改密码</a></li>
    ...
    <div id="main-content">
        ...
        <!-- Page Head -->
        <h2>欢迎你<?php echo ($role); ?>，<?php echo ($username); ?></h2>
                ...
                <div class="tab-content default-tab" id="tab1">
                    ...
                    <table>
                        ...
                        <?php if(is_array($stus)): $i = 0; $__LIST__ = $stus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$stu): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><a href="#" title="title"><?php echo ($stu['sex']); ?></a></td>
                                ...
                                <td>
                                    <!-- Icons -->
                                    <a  href="http://localhost/cms2/index.php/home/user/showUpdate/id/<?php echo ($stu['id']); ?>" title="Edit">
                                        <img src="/cms2/Public/images/icons/pencil.png" alt="Edit" /></a>
                                    <a href="http://localhost/cms2/index.php/home/user/del/id/<?php echo ($stu['id']); ?>" title="Delete"><img src="/cms2/Public/images/icons/cross.png" alt="Delete" /></a>
                                </td>
