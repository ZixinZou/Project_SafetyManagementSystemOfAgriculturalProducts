...
<div id="body-wrapper">
    ...
    <div id="sidebar">
        <div id="sidebar-wrapper">
            ...
            <div id="profile-links"> Hello, <?php echo ($username); ?> <br />
                <br />
                <a href="<?php echo U('Home/User/logout');?>" title="退出">退出</a> </div>     <ul id="main-nav">
                <!-- Accordion Menu -->
                ...
                <li> <a href="#" class="nav-top-item ">
                    ...
                    学生管理 </a>
                    <ul>
                        <li><a href="http://localhost/cms2/index.php/home/user/showAll">学员列表</a></li>
                        <li><a href="http://localhost/cms2/index.php/home/user/add">添加学生</a></li>

                    </ul>
                </li>
                <li> <a href="#" class="nav-top-item"> 用户管理 </a>
                    <ul>
                        <li><a href="http://localhost/cms2/index.php/home/user/showAll">用户列表</a></li>
                        <li><a href="http://localhost/cms2/index.php/home/user/showAdd">用户添加</a></li>
    ...
    <div id="main-content">
        ...
        <div class="content-box">
            ...
            <form action="http://localhost/cms2/index.php/home/user/update/id/<?php echo ($stu_list['id']); ?>" method="post">
                <table>
                    <tr><td>姓名</td><td><input type="text" name="name" value="<?php echo ($stu_list['name']); ?>"/></td></tr>
                    <tr><td>性别</td><td><input type="text" name="sex" value="<?php echo ($stu_list['sex']); ?>"/></td></tr>
                    <tr><td>年龄</td><td><input type="text" name="age" value="<?php echo ($stu_list['age']); ?>"/></td></tr>
                    <tr><td>成绩</td><td><input type="text" name="score" value="<?php echo ($stu_list['score']); ?>"/></td></tr>
                    <tr><td>班级</td><td><input type="text" name="class"  value="<?php echo ($stu_list['class']); ?>"/></td></tr>
                    <tr><td>年级</td><td><input type="text" name="grade"  value="<?php echo ($stu_list['grade']); ?>"/></td></tr>
