            ...
            <div class="content-box-content">
                <div class="tab-content default-tab" id="tab1">
                    ...
                    <table>
                        ...
                        <?php if(is_array($scc)): $i = 0; $__LIST__ = $scc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$scc): $mod = ($i % 2 );++$i;?><tr><td><a href="<?php echo U('Admin/stu/sccdetail',array('id'=>$scc['id']));?>"><?php echo ($scc['date']); ?></a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
