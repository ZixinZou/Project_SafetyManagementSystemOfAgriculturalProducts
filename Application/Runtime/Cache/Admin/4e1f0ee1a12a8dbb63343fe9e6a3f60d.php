            ...
            <form action="<?php echo U('Admin/User/add');?>" method="post">
                <table>
                   <tr><td>用户名</td><td><input type="text" name="username"/></td></tr>
                    ...
                    <tr><td>密码</td><td><input type="text" name="password" value="123456" readonly/></td></tr>
                    <tr><td>身份</td><td><input type="radio" name="role" value="1" checked />农户
                        <input name="role" type="radio" value="0" />饲料生产企业
                        <input name="role" type="radio" value="2" />管理员
                    <tr><td>地址</td><td><input type="text" name="address"/></td></tr>
                    <tr><td>电话</td><td><input type="text" name="telenumber"/></td></tr>
