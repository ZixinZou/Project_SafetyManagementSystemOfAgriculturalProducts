...
<div id="body-wrapper">
    ...
    <div id="main-content">
        ...
        <div class="content-box">
            ...
            <?php if(is_array($nvd)): $i = 0; $__LIST__ = $nvd;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nvd): $mod = ($i % 2 );++$i;?><div class="content-box-content">
                    <div class="tab-content default-tab" id="tab1">
                        <table>
                            <tr><td>填写人</td><td><?php echo ($nvd['username']); ?></td></tr>
                            <tr><td>填写时间</td><td><?php echo ($nvd['date']); ?></td></tr>
                            <tr><td>用药时间</td><td><?php echo ($nvd['usetime']); ?></td></tr>
                            <tr><td>用药对象</td><td><?php echo ($nvd['useobject']); ?></td></tr>
                            <tr><td>日龄</td><td><?php echo ($nvd['age']); ?></td></tr>
                            <tr><td>栋别</td><td><?php echo ($nvd['store']); ?></td></tr>
                            <tr><td>栏号</td><td><?php echo ($nvd['barrier']); ?></td></tr>
                            <tr><td>症状（处方编号）</td><td><?php echo ($nvd['symptomnum']); ?></td></tr>
                            <tr><td>用药</td><td><?php echo ($nvd['medicine']); ?></td></tr>
                            <tr><td>给药剂量</td><td><?php echo ($nvd['dose']); ?></td></tr>
                        </table>
                    </div>
                </div>

                <h3><a href="<?php echo U('Admin/invest/nvdok',array('id'=>$nvd[id]));?>">合格</a></h3>
                <h3><a href="<?php echo U('Admin/invest/nvdfail',array('id'=>$nvd[id]));?>">不合格</a></h3><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
